        ...
        <nav class="flex-1 px-3 py-4 space-y-0.5 text-sm overflow-y-auto">
            @php
                $nav = [
                    ...
                    ['route' => 'cameras.monitoring', 'label' => 'Live Monitor', 'icon' => 'M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z', 'roles' => ['admin','manager','hr']],
                ...
                $adminNav = [
                    ...
                    ['route' => 'workers.faces',        'label' => 'Model Wajah',  'icon' => 'M5.121 17.804A13.937 13.937 0 0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0zm6 2a9 9 0 11-18 0 9 9 0 0118 0z'],
                ];
            @endphp
...
async function api(method, url, body = null) {
    ...
    if (res.status === 401) {
        // Session expired — redirect only if not already mid-navigation
